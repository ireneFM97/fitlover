  ...
  const [isStopped, setIsStopped] = useState(false); // Nuevo estado
    ...
    // Añadir una nueva serie a un ejercicio
                  ...
                  <div key={index} className="container-rep">
                    <label>
                      ...
                      <input
                        ...
                        onChange={(e) => updateSeries(day, exercise.id, index, 'repeticiones', e.target.value)}
                      />
                    </label>
                    <label>
                      Peso:
                      <input
                        type="text"
                        value={serie.peso}
                        onChange={(e) => updateSeries(day, exercise.id, index, 'peso', e.target.value)}
                      />kg
                    </label>
                    <div className="container-add-remove-reps">
                      <button className="button-series" onClick={() => addSeries(day, exercise.id, exercise.muscle === 'Cardio')}>+</button>
